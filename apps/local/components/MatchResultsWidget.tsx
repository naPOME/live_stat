      ...
      <div style={{ background: p.bg, width: '100%', padding: '48px 24px 64px', fontFamily: "'Roboto', sans-serif" }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ background: p.cardBg, borderRadius: 24, boxShadow: p.cardShadow, border: `1px solid ${p.separator}`, overflow: 'hidden' }}>
            ...
            <div style={{ position: 'relative', overflow: 'hidden', padding: '48px 40px', display: 'flex', flexWrap: 'wrap', gap: 40, alignItems: 'center', justifyContent: 'space-between', borderBottom: `1px solid ${p.separator}` }}>
              ...
              <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: `linear-gradient(135deg, ${p.cardBg} 20%, ${p.cardBg}dd 60%, transparent 100%)` }}></div>
            ...
            <div style={{ padding: '40px', background: p.cardBg }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 24 }}>
                {displayPlayers.map((player, idx) => (
                  <div key={idx} style={{ background: p.bg, borderRadius: 16, border: `1px solid ${p.separator}`, overflow: 'hidden' }}>
